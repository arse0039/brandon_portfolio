...
const AboutPage= ( {handleModalClick} : AboutPageProps ) => {
    ...
    const handleAvatarClick = ( event: React.MouseEvent<HTMLDivElement> ) => {
        handleModalClick();
        event.currentTarget.id.includes('david') ? setDavidClick(true) : setBrandonClick(true);
    };
    ...
    return (
        <div id='about-outer-div'>
            ...
            <AboutModal davidClicked={davidClick} brandonClicked={brandonClick} handleModalClose={handleModalClose}/>
            <div className='about-individual'>
