...
import mlCapstone from '../assets/MLcapstone.png';
import uffdaGif from '../assets/uffdaGif2.gif';
...
export const projects = [
    {
        ...
        projectSkills: ["AI/ML", "React.js", "Python", "TensorFlow"],
        github: 'https://github.com/arse0039/capstone',
    },
    {
        projectImage: uffdaGif,
        ...
        projectSkills: ["React.js", "SQL", "node.js"],
