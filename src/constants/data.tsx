...
export const davidProfile: Profile = {
  ...
  intro: [
    "After 8 years in Business Operations as a Project Manager, People Manager, and Data Analyst, I embraced my passion for technology \
    and problem-solving and returned to school to pursue a degree in Computer Science.",
    " Working in Business Ops \
    ...
    "Over the course of my degree program, I worked full-time, held a part-time position as a teaching \
    ...
    project. I returned to school following the internship and graduated in December.",
    "In addition to working on projects with Brandon, I'm now \
